...
<!-- ecran = engagementRSE.blade.php   -->


@section('title')
  Nos engagements RSE pour promouvoir la durabilité et l’éthique
@endsection
...
@section('metaDescription')
  Chez fiu, nous contribuons à créer un impact positif sur les personnes, la planète et les pratiques qui touchent notre entreprise. Découvrez comment !
@endsection
...
<div class="flex-wrap-row bloc-one-rse" style=" margin-top: 90px; ">
          ...
          <div class="col-6" style=" background-color: #1C4151; position: relative; overflow: hidden; ">
            ...
            <div style=" position: absolute; top: 3%; ">
              <img src="{{ asset('assets/img/emoji-1-rse.png')}}" width="250px" height="250px" alt="personnage jaune de forme ronde qui sourit" />
            </div>
            <div style=" position: absolute; bottom: -6%; right: 5%; ">
              <img src="{{ asset('assets/img/emoji-2-rse.png')}}" width="250px" height="250px" alt="personnage vert en pleine refléxion" />
            </div>
          </div>
        </div>
            ...
            <div class="col-6">
              <div style=" padding-left: 10%; padding-right: 2%; ">
                ...
                <p class="font-m-whoAreWe">
                  Chez <strong><?php echo str_replace("&", " ", getenv('nameFiu')); ?></strong> , nous avons à cœur de fonctionner en toute transparence, que ce soit à
                ...
                <p class="font-m-whoAreWe">
                  ...
                  privée. <b><?php echo str_replace("&", " ", getenv('nameFiu')); ?></b> dispose d'une équipe de développeurs dédiée qui garantit à la fois la sécurité des
              ...
              <!-- Debut bloc left -->
                <div class="items-center justify-content-center" style=" padding-top: 5%; position: relative; ">
                    <div style=" display: inline-block; ">
                        <img src="{{ asset('assets/img/AdobeStock_285697469.png') }}" style="width: 100%; height: 100%; " alt="deux femmes en pleine conversation dans un espace professionnel lumineux, vues à travers un encadrement de plantes" />
                        ...
                        <img src="{{ asset('assets/img/emoji-3-rse.png') }}" width="100%" height="100%" alt="personnage violet se posant des questions" />
                        </div>
                    </div>
                </div>
              <!-- Fin bloc left -->
          ...
          <div class="flex-wrap-row">
            <div class="col-6">
              <div style=" padding-left: 9%; padding-right: 2%; " class="font-m-whoAreWe">
                <p>
                  Notre ambition au sein de <b><?php echo str_replace("&", " ", getenv('nameFiu')); ?></b> est d'agir en employeur responsable, de soutenir la diversité,
                ...
                <div class="row">
                  ...
                  >
                    ...
                    <div style=" position: absolute; top: 5%; left: 14%; ">
                      <img src="{{ asset('assets/img/etoileGrandRse.png') }}" width="25.57px" height="25.61px" alt="Quatre traits blancs formant un grand X" />
                    </div>
                    <div style=" position: absolute; top: 10%; right: 8%; ">
                      <img src="{{ asset('assets/img/etoileGrandRse.png') }}" width="25.57px" height="25.61px" alt="Quatre traits blancs formant un grand X" />
                    </div>
                    <div style=" position: absolute; top: 20%; right: 17%; ">
                      <img src="{{ asset('assets/img/etoileGrandRse.png') }}" width="18.33px" height="18.35px" alt="Quatre traits blancs formant un grand X" />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="flex-wrap-row">
            <div class="col-6">
              <div style=" padding-left: 9%; padding-right: 9%; ">
                ...
                <p class="font-m-whoAreWe">
                  <strong><?php echo str_replace("&", " ", getenv('nameFiu')); ?></strong> réserve une place centrale à cette question dans sa gouvernance en menant une
            ...
            <div class="col-6 items-center justify-content-center">
              <div>
                <img src="{{ asset('assets/img/emoji4-rse.png') }}" width="350px" height="350px" alt="Visage de nuage bleu apaisé, sourire tranquille" />
              </div>
            </div>
          </div>
            ...
            <div class="flex-wrap-row">
              <div class="col-6">
                ...
                <p style=" padding-left: 8%; padding-right: 8%; margin-top: 0.5em; " class="font-m-whoAreWe">
                  ...
                  <b><?php echo str_replace("&", " ", getenv('nameFiu')); ?></b> ne fait plus l'acquisition de ce type de véhicule depuis septembre 2022.
                </p>
                <p style=" padding-left: 8%; padding-right: 8%; margin-bottom: 0; " class="fontSubTitle">
        ...
        <div style=" padding: 3% 5% 5% 5%; ">
          ...
          <div class="flex-wrap-row" style=" height: 100%; ">
            ...
            <div class="col-6" style=" position: relative; ">
              ...
              <div class="items-center justify-content-center" style=" padding-top: 5%; position: relative; ">
                    <div style=" display: inline-block; ">
                        <img src="{{ asset('assets/img/AdobeStock_220104112.png') }}" width="100%" height="100%" alt="groupe de coworkers attentifs et souriants en pleine réunion ou session de travail collaboratif, avec une femme aux cheveux gris au premier plan, concentrée devant un ordinateur portable" />
                        <p style=" padding-top: 5%; " class="font-m-whoAreWe">
                        Vous avez des questions ?
                        </p>
                        <a href="{{ url('/contact') }}">
...
<!-- WebPage (Engagements RSE) -->
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "@id": "https://flexinuse.fr/engagements-rse#webpage",
  "url": "https://flexinuse.fr/engagements-rse",
  "name": "Engagements RSE | fiu – Flex In Use",
