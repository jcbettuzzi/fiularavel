...
<!-- ecran = registerCodeMdp.blade.php   -->
@section('title')
  Fiu
@endsection
@section('pagetitle')
      ...
      <div class="row min-vh-100">
        ...
        @endif
            ...
            <form method="POST" action="{{ url('/registerCodeMdp') }}">   
              ...
              <hr class="my-4">
              <div class="d-grid">
              <button  class="btn btn-link  text-muted " type="submit" name="submitbutton" value="SansMotdepasse">S'enregitrer sans mot de passe.</button>
              </div>
              <div class="d-grid">
              <button  class="btn btn-link  text-muted " type="submit" name="submitbutton" value="AvecMotdepasse">S'enregistrer avec un mot de passe.</button>
              </div>
              <div class="d-grid">
              <button  class="btn btn-link  text-muted " type="submit" name="submitbutton" value="Avecuncode">S'enregistrer avec un code dans votre messagerie.</button>
              </div>
