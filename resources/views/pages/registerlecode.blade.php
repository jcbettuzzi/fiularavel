...
<!-- ecran = registerlecode.blade.php   -->
@section('title')
  Fiu
@endsection
@section('pagetitle')
...
<div class="container-fluid px-3">
      <div class="row min-vh-100">
        ...
        @endif
            ...
            Veuillez saisir le code que vous avez reçu par mail.
                <div class="mb-4">
              ...
              <!-- Submit-->
              <div class="d-grid">
                <button class="btn btn-lg btn-primary" type="submit" name="submitbutton" value="Senregistrer">Valider votre compte</button>                
              </div>
