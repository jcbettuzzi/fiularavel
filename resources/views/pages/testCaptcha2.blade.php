...
<!-- ecran = testCaptcha2.blade.php   -->
@section('recaptcha')
<script src="https://www.google.com/recaptcha/api.js?render=6LcJC5QqAAAAAPP_aKshsYSB-SZ2rtMwE7pn6abL"></script>
@endsection
@section('title')
  Fiu
@endsection
...
<div style="margin-top: 90px;">
                <form class="form" id="my-form" method="POST" action="{{ url('/postTestCapcha123ABC') }}" autocomplete="off">
...
<script>
    grecaptcha.ready(function() {
        grecaptcha.execute('6LcJC5QqAAAAAPP_aKshsYSB-SZ2rtMwE7pn6abL', { action: 'submit' }).then(function(token) {
