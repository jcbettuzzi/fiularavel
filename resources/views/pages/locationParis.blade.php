...
<div class="flex-wrap-row" style="height: 100%;">
   ...
   <div class="col-8">
      ...
      <div style="padding-left: 5%; padding-right: 5%;">
         ...
         <p class="font-m">Néanmoins, la plupart ne permettent pas de savoir quelle typologie de bureau est faite pour vous. Le type de contrat notamment doit faire l’objet d’une vigilance particulière, car certains contrats sont peu flexibles et vous engagent sur une longue période. <b>Chez fiu, nous vous aidons à trouver une solution sur mesure qui répondra à vos attentes.</b></p>
      </div>
      ...
      <div style="padding-left: 5%; padding-right: 5%;">
         ...
         <p class="font-m"><b>Trouvez votre bureau idéal chez fiu :</b></p>
...
<div class="row wd-100 bg-violet blanc boxRadiusTopLeft" style="position: relative;">
   <div class="column wd-100 justify-content-center" style="padding-left: 8%; padding-top: 2%; min-height: 463px; padding-bottom: 3%; position: relative;">
      ...
      <p class="font-m-whoAreWe wd-50 asoSansRegularBase" style="margin-top: 0px;">Pas de panique&nbsp;! <b>fiu</b> vous aide à identifier vos besoins, orienter votre recherche et trouver la perle rare&nbsp;!</p>
