...
@section('title')
   Le guide du coworking : ce qu'il faut savoir
@endsection
...
@section('metaDescription')
   Le coworking à Paris évolue ! Explorez les nouveaux services proposés aux entreprises et aux start-up dans ces espaces flexibles.
@endsection
@section('pagetitle')
  Fiu Laravel
@endsection
...
<div class="flex-wrap-row bloc-one-rse" style="margin-top:90px">
   ...
   <div class="col-6 items-center justify-content-center" style="background-color:#FFF6F0;position:relative">
      ...
      <div style="position:absolute;top:1%;left:5%" class="width-emoji-redirectCTA">
         <img src="{{ asset('assets/img/perso-5.png')}}" height="80%" width="80%" alt="personnage rose qui ferme les yeux" />
      </div>
      <div style="position:absolute;bottom:0;right:5%;rotate:-9deg" class="width-emoji-redirectCTA">
         <img src="{{ asset('assets/img/Persos-18.png')}}" width="100%" height="100%" alt="personnage violet avec un air étonné, avec des interrogations" />
      </div>
   </div>
</div>
<div class="flex-wrap-row" style="height:100%">
   ...
   <div class="flex-wrap-row wd-100 bg-violet boxRadiusTopLeft" style="padding-left:8%;padding-top:2%;min-height:463px;padding-bottom:3%;position:relative;background-color:rgb(246, 206, 222)">
      ...
      <div class="col-3 items-center justify-content-center">
         <div style="z-index:0" class="emoji-today-coworking">
            <img src="{{ asset('assets/img/Persos-maquettes-9.png')}}" height="100%" width="100%" alt="personnage orange qui regarde sur le côté qui sourit avec une casquette" />
         </div>
      </div>
   </div>
   <div class="col-10 marginContentCoworking">
   ...
   <div class="flex-wrap-row wd-100">
      <div class="col-5 height-partImage-typeCoworking" style="position:relative">
            <img
              alt="Femme travaillant sur ordinateur portable en espace de coworking avec ambiance conviviale"
   ...
   <div class="flex-wrap-row wd-100" style="margin-top:3%;flex-wrap:wrap-reverse">
      ...
      <div class="col-5 height-partImage-typeCoworking" style="position:relative">
         <img
              alt="Groupe de personnes travaillant ensemble sur ordinateurs portables dans un espace de coworking moderne"
   ...
   <div class="flex-wrap-row wd-100" style="margin-top:3%">
      <div class="col-5 height-partImage-typeCoworking" style="position:relative">
         <img
              alt="Employés travaillant dans un open space de coworking moderne et collaboratif"
   ...
   <div class="flex-wrap-row wd-100" style="margin-top:3%;flex-wrap:wrap-reverse">
      ...
      <div class="col-5 height-partImage-typeCoworking" style="position:relative">
         <img
              alt="Open space de coworking avec bureaux design et grandes fenêtres donnant sur la ville"
   ...
   <div class="col-10" style="margin-left:15%;margin-right:15%;position:relative;height:80vh">
      <img
              alt="groupe de coworker  qui regardent le telephone au bureau"
              src="{{ asset('assets/img/gens-qui-regardent-le-telephone-au-bureau.jpg')}}"
              class="object-center object-cover pointer-events-none"
              style="object-fit:cover;object-position:center;width:100%;height:100%;"
      />
   </div>
   ...
   <div class="col-10" style="margin-left:15%;margin-right:15%;position:relative;height:80vh">
      <div>
         <span style="box-sizing:border-box;display:block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:absolute;top:0;left:0;bottom:0;right:0">
            <img alt="Groupe de collègues échangeant et applaudissant lors d’une réunion en coworking collaboratif" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" decoding="async" data-nimg="fill" class="object-center object-cover pointer-events-none" style="position:absolute;top:0;left:0;bottom:0;right:0;box-sizing:border-box;padding:0;border:none;margin:auto;display:block;width:0;height:0;min-width:100%;max-width:100%;min-height:100%;max-height:100%;object-fit:cover;object-position:center">
            <noscript><img alt="Groupe de collègues échangeant et applaudissant lors d’une réunion en coworking collaboratif" sizes="100vw" srcSet="/_next/image?url=%2F_bureau-privatif-coworking-paris.jpeg&amp;w=640&amp;q=75 640w, /_next/image?url=%2F_bureau-privatif-coworking-paris.jpeg&amp;w=750&amp;q=75 750w, /_next/image?url=%2F_bureau-privatif-coworking-paris.jpeg&amp;w=828&amp;q=75 828w, /_next/image?url=%2F_bureau-privatif-coworking-paris.jpeg&amp;w=1080&amp;q=75 1080w, /_next/image?url=%2F_bureau-privatif-coworking-paris.jpeg&amp;w=1200&amp;q=75 1200w, /_next/image?url=%2F_bureau-privatif-coworking-paris.jpeg&amp;w=1920&amp;q=75 1920w, /_next/image?url=%2F_bureau-privatif-coworking-paris.jpeg&amp;w=2048&amp;q=75 2048w, /_next/image?url=%2F_bureau-privatif-coworking-paris.jpeg&amp;w=3840&amp;q=75 3840w" src="/_next/image?url=%2F_bureau-privatif-coworking-paris.jpeg&amp;w=3840&amp;q=75" decoding="async" data-nimg="fill" style="position:absolute;top:0;left:0;bottom:0;right:0;box-sizing:border-box;padding:0;border:none;margin:auto;display:block;width:0;height:0;min-width:100%;max-width:100%;min-height:100%;max-height:100%;object-fit:cover;object-position:center" class="object-center object-cover pointer-events-none" loading="lazy"/></noscript>
         </span>
      </div>
      <img
              alt="plusieurs personnes qui marche devant l'entrée du bâtiment"
...
<div class="row wd-100 bg-violet blanc boxRadiusTopLeft" style="position:relative">
   <div class="column wd-100 justify-content-center" style="padding-left:8%;padding-top:2%;min-height:463px;padding-bottom:3%;position:relative">
      ...
      <p class="font-m-whoAreWe wd-50 asoSansRegularBase" style="margin-top:0">Pas de panique&nbsp;! <b><?php echo str_replace("&", " ", getenv('nameFiu')); ?></b> vous aide à identifier vos besoins, orienter votre recherche et trouver la perle rare&nbsp;!</p>
