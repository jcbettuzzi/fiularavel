    ...
    <header class="header">
      ...
      <nav class="navbar navbar-expand-lg fixed-top shadow navbar-light bg-white">
        <div class="container-fluid">
          ...
          <div class="d-flex align-items-center"><a class="navbar-brand py-1" href="index.html"><img src="{{ asset('img/logo.svg')}}" alt="Directory logo"></a>
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
              ...
              <li class="nav-item dropdown position-static"><a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Template</a>
                <div class="dropdown-menu megamenu py-lg-0">
                  <div class="row">
                    ...
                    <div class="col-lg-3 d-none d-lg-block position-relative"><img class="bg-image" src="{{ asset('img/photo/photo-1521170665346-3f21e2291d8b.jpg')}}" alt=""></div>
                  </div>
                </div>
              </li>
              <!-- /Megamenu end-->
            ...
            @else 
                <li class="nav-item"><a class="nav-link" href="{{ url('Sesigner') }}">Se connecter</a></li>
            @endif
            @if(Session::get('usersigne')==1)                                  
              <li class="nav-item"><a class="nav-link" href="{{ url('Supprimerlecompte') }}">Supprimer le compte</a></li>
            @endif                
          ...
          <div class="row align-items-center">
            ...
            <div class="col-md-6">
              <ul class="list-inline mb-0 mt-2 mt-md-0 text-center text-md-end">
                ...
                <li class="list-inline-item"><img class="w-2rem" src="{{ asset('img/visa.svg')}}" alt="..."></li>
                <li class="list-inline-item"><img class="w-2rem" src="{{ asset('img/mastercard.svg')}}" alt="..."></li>
                <li class="list-inline-item"><img class="w-2rem" src="{{ asset('img/paypal.svg')}}" alt="..."></li>
                <li class="list-inline-item"><img class="w-2rem" src="{{ asset('img/western-union.svg')}}" alt="..."></li>
              </ul>
            </div>
          </div>
        </div>
