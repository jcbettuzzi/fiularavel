          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <ul class="navbar-nav ms-auto">
              ...
              @if(Session::get('usersigne')==0)                                  
                <li class="nav-item"><a class="nav-link" href="{{ url('registerSansMDP') }}">Se connecter sans MDP</a></li>             
             @endif
              ...
              <li class="nav-item"><a class="nav-link" href="{{ url('offredetail/4655') }}">Détail d'une offre</a></li>
